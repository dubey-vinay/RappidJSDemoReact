...
<script lang="ts">
    ...
    import MessageInspector from 'src/components/inspector/message-inspector/message-inspector.vue';
    import LabelInspector from 'src/components/inspector/label-inspector/label-inspector.vue';
    import LinkInspector from 'src/components/inspector/link-inspector/link-inspector.vue';
